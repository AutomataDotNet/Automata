...
public static class HtmlEncode_B{
                ...
                if ((0x1000>c)) {
                  ...
                  if (((0xD800<=c)&&(c<=0xDBFF))) {
                    ...
                    if ((((0xDC00<=c)&&(c<=0xDFFF))||(c==0xFFFF)||(c==0xFFFE))) {
                      throw new Exception("HtmlEncode_B");
                    } else {
...
case (1): {
  if (((0xDC00<=c)&&(c<=0xDFFF))) {
    output[pos++] = ((char)((((Bits(13,0,r0)<<2)|Bits(9,8,c))&0xF)+((((Bits(13,0,r0)<<2)|Bits(9,8,c))&0xF)<=9 ? 48 : 55)));output[pos++] = ((char)(((c>>4)&0xF)+(((c>>4)&0xF)<=9 ? 48 : 55)));output[pos++] = ((char)((c&0xF)+((c&0xF)<=9 ? 48 : 55)));output[pos++] = ((char)0x3B);
    r0 = 0;
    state = 0;
  } else {
    throw new Exception("HtmlEncode_B");
