...
namespace Microsoft.Automata
{
    internal class STbComposer<FUNC, TERM, SORT>
    {
        ...
        private STbRule<TERM> EvalB(ConsList<TERM> inputs, int qA, TERM regA, TERM pathCond, int qB, TERM regB, Func<int, int, int> stateComposer, Sequence<TERM> outputFromB, bool isFinal)
        {
            if (inputs == null)
            {
