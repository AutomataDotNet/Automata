...
namespace Microsoft.Automata
{
    ...
    public enum Bool3 { Yes, No, Unknown };
    internal class STbSimplifier<FUNC, TERM, SORT>
    {
        ...
        STbRule<TERM> Prune(IPF<TERM> pf, STbRule<TERM> rule, Action<int> updateSearch)
        {
            return PruneHelp(pf, stb.Solver.True, rule, updateSearch);
        }
        STbRule<TERM> PruneHelp(IPF<TERM> pf, TERM cond, STbRule<TERM> rule, Action<int> updateSearch)
        {
    ...
    public abstract class IPFbuilder<TERM>
    {
