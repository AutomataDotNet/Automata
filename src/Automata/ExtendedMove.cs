...
namespace Microsoft.Automata
{
    ...
    public abstract class ExtendedMove<TERM>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="LAB">the type of the labels of moves</typeparam>
    public class ExtendedFinalMove<TERM> : ExtendedMove<TERM>
    {
        /// <summary>
        /// Final move
        /// </summary>
    ...
    /// </summary>
    /// <typeparam name="LAB">the type of the labels of moves</typeparam>
    public class ExtendedNormalMove<TERM> : ExtendedMove<TERM>
    {
        /// <summary>
        /// Source state of the move
        /// </summary>
        ...
        /// <param name="sourceState"></param>
        /// <param name="condition"></param>
        public ExtendedNormalMove(int sourceState, int TargetState, ExtendedAction<TERM> action) :
            base(sourceState, action)
        {
