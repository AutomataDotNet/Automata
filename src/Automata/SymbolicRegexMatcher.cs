...
namespace Microsoft.Automata
{
    ...
    internal class SymbolicRegexMatcher<S>
    {
        ...
        #region safe version of Matches and IsMatch

        /// <summary>
        /// Generate all earliest maximal matches. We know that k is at least 2.
        /// Unsafe version of FindMatches.
        ...
        /// <summary>
        ///  Find first occurrence of startset elelment in input starting from index i.
        /// </summary>
        /// <param name="input">input string to search in</param>
        ...
        int IndexOfStartset(string input, int i)
        {
            ...
            {
                char c = input[i];
                bool res = this.A_StartSet.IsMember(c);
                if (res)
                {
                    start_pos = i;
                    break;
        ...
        //#region unsafe version of Matches and IsMatch
        ...
        ///// <paramref name="k">length of input string</paramref>
        ///// </summary>
        //unsafe internal Tuple<int, int>[] MatchesU(char* input, int k)
        //{
        ...
        //    //TBD: dont enforce match_start_boundary when match overlaps are allowed
        //    bool A_has_nonempty_prefix = (A_prefix != string.Empty);
        //    while (true)
        //    {
        //        int i_q0_A1;
        //        i = (A_has_nonempty_prefix ?
        //            FindFinalStatePositionOptU(input, k, i, out i_q0_A1) :
        //            FindFinalStatePositionU(input, k, i, out i_q0_A1));
        ...
        //        int i_start = FindStartPositionU(input, i, i_q0_A1/* match_start_boundary */);

        //        int i_end = FindEndPosition(input, k, i_start);
        ...
        ///// Returns true iff the input string matches A.
        ///// </summary>
        //unsafe internal bool IsMatch(char *input, int k)
        //{
        //    if (this.A.containsAnchors)
        //    {
        //        //separate case when A contains anchors
        ...
        //        if (A.FixedPrefix != string.Empty)
        //        {
        //            i = FindFinalStatePositionOptU(input, k, 0, out i_q0);
        //        }
        //        else
        //        {
        //            i = FindFinalStatePositionU(input, k, 0, out i_q0);
        //        }
        //        if (i == k)
        //        {
        //            //the search for final state exceeded the input, so final state was not found
        ...
        ///// <param name="i">start position</param>
        ///// <returns></returns>
        //unsafe private int FindEndPosition(char *input, int k, int i)
        //{
        //    int i_end = k;
        //    int q = q0_A;
        //    while (i < k)
        ...
        ///// <param name="match_start_boundary">do not pass this boundary when walking back</param>
        ///// <returns></returns>
        //unsafe private int FindStartPositionU(char *input, int i, int match_start_boundary)
        //{
        //    int q = q0_Ar;
        //    SymbolicRegex<S> regex = null;
        //    //A_r may have a fixed sequence
        ...
        ///// <param name="i_q0">last position the initial state of A1 was visited</param>
        ///// <returns></returns>
        //unsafe private int FindFinalStatePositionU(char *input, int k, int i, out int i_q0)
        //{
        //    int q = q0_A1;
        //    int i_q0_A1 = i;
        ...
        //        if (q == q0_A1)
        //        {
        //            int j = IndexOfStartset(input, k, i);
        //            i = j;
        ...
        ///// FindFinalState optimized for the case when A starts with a fixed prefix
        ///// </summary>
        //unsafe private int FindFinalStatePositionOptU(char *input, int k, int i, out int i_q0)
        //{
        //    int q = q0_A1;
        //    int i_q0_A1 = i;
        //    //S[] prefix = this.A_prefix_array;
        //    //it is important to use Ordinal/OrdinalIgnoreCase to avoid culture dependent semantics of IndexOf
        //    while (i < k)
        //    {
        //        SymbolicRegex<S> regex = null;
        ...
        //            if (q == q0_A1)
        //            {
        //                i = IndexOf(input, k, A_prefix, i, A_fixedPrefix_ignoreCase);
        //                i_q0_A1 = i;
        ...
        ///// <summary>
        /////  Find first occurrence of str in input starting from index i.
        ///// </summary>
        ///// <param name="input">input string to search in</param>
        ///// <param name="k">length of input string</param>
        ///// <param name="str">the subsequence that is searched for</param>
        ///// <param name="i">the start index in input</param>
        ///// <returns></returns>
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        //unsafe int IndexOf(char *input, int k, string str, int i, bool caseInsensitive)
        //{
        //    //if (str.Length == 1)
        //    //    return IndexOfElem(input, k, str[0], i);
        ...
        //    {
        //        int j = 0;
        //        while (j < s_length && input[i + j] == str[j])
        //            j += 1;
        //        if (j == s_length)
        //        {
        //            i_res = i;
        ...
        //        {
        //            char c = input[i];
        //            int c_id = (c < this.dt.precomputed.Length ? this.dt.precomputed[c] : this.dt.bst.Find(c));
        //            S c_atom = this.atoms[c_id];
        //            S conj = this.builder.solver.MkAnd(c_atom, str_pred);
        //            if (this.builder.solver.IsSatisfiable(conj))
        //            {
        //                matchFound = true;
        ...
        //                    str_pred = str[j];
        //                    c = input[i + j];
        //                    c_id = (c < this.dt.precomputed.Length ? this.dt.precomputed[c] : this.dt.bst.Find(c));
        //                    c_atom = this.atoms[c_id];
        //                    conj = this.builder.solver.MkAnd(c_atom, str_pred);
        //                    if (!this.builder.solver.IsSatisfiable(conj))
        //                    {
        //                        matchFound = false;
        //                        str_pred = str[0];
        ...
        ///// <param name="input">input string to search in</param>
        ///// <param name="k">length of input string</param>
        ///// <param name="pred">the predicate is searched for</param>
        ///// <param name="i">the start index in input</param>
        ///// <returns></returns>
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        //unsafe int IndexOfStartset(char* input, int k, int i)
        //{
        //    int start_pos = -1;
        //    while (i < k)
        //    {
